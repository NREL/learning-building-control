...
# MPC
sbatch --time=2:00:00 run_mpc.sh 4
sbatch --time=2:00:00 run_mpc.sh 8
sbatch --time=2:00:00 run_mpc.sh 12
sbatch --time=4:00:00 run_mpc.sh 24
sbatch --time=8:00:00 run_mpc.sh 36
sbatch --time=12:00:00 run_mpc.sh 48
...
# # CPL with learning
sbatch --time=4:00:00 run_cpl.sh 4 1
sbatch --time=8:00:00 run_cpl.sh 8 1
sbatch --time=16:00:00 run_cpl.sh 12 1
sbatch --time=32:00:00 run_cpl.sh 24 1

# DPC
sbatch --time=4:00:00 run_dpc.sh
